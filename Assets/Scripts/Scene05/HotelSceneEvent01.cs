...
public class HotelSceneEvent01 : MonoBehaviour
{
    ...
    public GameObject charTobaccioMouthOpen1;
    public GameObject charTobaccioMouthClose1;
    public GameObject charTobaccio2;
    public GameObject charTobaccio2MouthOpen1;
    public GameObject charTobaccio2MouthClose1;
    public GameObject charFrontDesk;
    public GameObject charFrontDeskMouthClose1;
    public GameObject charFrontDeskMouthOpen1;
    ...
    IEnumerator EventTwelve()
    {
        ...
        charCoinSmirk.SetActive(false);
        charFrontDesk.SetActive(false);
        charFrontDeskMouthClose1.SetActive(true);
        charFrontDeskMouthOpen1.SetActive(false);
        charTobaccio.SetActive(false);
        charTobaccioMouthOpen1.SetActive(true);
        charTobaccioMouthClose1.SetActive(false);
        charTobaccio2.SetActive(false);
        charKT.SetActive(false);
        charKT2.SetActive(false);
        textBox.SetActive(true);
    ...
    IEnumerator EventThirteen()
    {
        ...
        charCoinSmirk.SetActive(false);
        charFrontDesk.SetActive(false);
        charFrontDeskMouthOpen1.SetActive(true);
        charFrontDeskMouthClose1.SetActive(false);
        charTobaccio.SetActive(false);
        charTobaccioMouthOpen1.SetActive(false);
        charTobaccioMouthClose1.SetActive(true);
        charTobaccio2.SetActive(false);
        charKT.SetActive(false);
        charKT2.SetActive(false);
        textBox.SetActive(true);
    ...
    IEnumerator EventtwentyOne()
    {
        ...
        charTobaccio2MouthClose1.SetActive(false);
        charTobaccio2MouthOpen1.SetActive(false);
        charKT.SetActive(true);
        charKT2.SetActive(false);
        textBox.SetActive(true);
        charName.GetComponent<TMPro.TMP_Text>().text = "Tobaccio";
    ...
    IEnumerator EventTwentyTwo()
    {
        ...
        charTobaccio.SetActive(false);
        charTobaccio2.SetActive(false);
        charTobaccio2MouthClose1.SetActive(true);
        charTobaccio2MouthOpen1.SetActive(false);
        charKT.SetActive(true);
        charKT2.SetActive(false);
        textBox.SetActive(true);
    ...
    IEnumerator EventTwentySeven()
    {
        ...
        charTobaccio.SetActive(false);
        charTobaccio2.SetActive(false);
        charTobaccio2MouthOpen1.SetActive(true);
        charTobaccio2MouthClose1.SetActive(false);
        charKT.SetActive(true);
        charKT2.SetActive(false);
        textBox.SetActive(true);
